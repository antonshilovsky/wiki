...
<div style="text-align:center;">
  <h1>Бизнес-аналитик. Лектор. Исследователь с фокусом на бизнес-выгоды</h1>
  <img src="images/main_new.png" alt="Антон Шиловский" width="260" style="border-radius:12px; margin:1em 0;">
</div>
...
### Бизнес-аналитик (март 2024 — наст. время)
...
### Эксперт программ (июнь 2025 — наст. время)
Разработка и проведение программ повышения квалификации:
...
**Результат:**  начитка и сопровождение курсов профпереподготовки — 505 академических часов: 800 слушателей, 88% из них удовлетворены курсом.

---

### Ведущий редактор (2020 — 2024)
