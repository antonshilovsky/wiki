...
Эксперт в анализе данных и автоматизации бизнес-процессов с фокусом на эффективность и цифровую трансформацию.
...
**Возраст:** 28 лет  
**Опыт работы:** 8 лет
**Готовность:** к переезду и удалённой работе  
...
- Построение дашбордов в Power BI и Superset.  
- Проведение анализа контрагентов и формализация условий сотрудничества.  
**Результат:** внедрено корпоративное решение для скоринговой оценки контрагентов (3000+ источников).
...
**Результат:** рост посещаемости сайта +50 тыс. в год, обучение ок. 10 сотрудников.
...
- Участник Interfax-lab, Power BI Russia, Superset Community.  
